...
{% set has_featured_banners = settings.banner_01_show and "banner_01.jpg" | has_custom_image %}

{% if settings.home_order_position_1 == 'featured_banners' and has_featured_banners %}
    {% set featured_banner_image = 'banner_01.jpg' | static_url %}
    <link rel="preload" as="image" href="{{ featured_banner_image | settings_image_url('original') }}" imagesrcset="{{ featured_banner_image | settings_image_url('large') }} 480w, {{ featured_banner_image | settings_image_url('huge') }} 640w, {{ featured_banner_image | settings_image_url('original') }} 1024w, {{ featured_banner_image | settings_image_url('1080p') }} 1920w">
{% endif %}
