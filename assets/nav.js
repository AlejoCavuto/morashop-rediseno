  ...
  const NAV_LINKS = [
    {
      ...
      subs: [
        { href: 'suplementos.html?tipo=vitaminas-salud', label: 'Vitaminas y Salud' },
        { href: 'suplementos.html?tipo=proteinas', label: 'Proteínas' },
        { href: 'suplementos.html?tipo=creatinas', label: 'Creatinas' },
        { href: 'suplementos.html?tipo=bcaa-aminos', label: 'BCAA y aminoácidos' },
        { href: 'suplementos.html?tipo=quemadores', label: 'Quemadores' },
        { href: 'suplementos.html?tipo=pre-entrenos', label: 'Pre-entrenos' },
        { href: 'suplementos.html?tipo=snacks-proteicos', label: 'Snacks proteicos' },
        { href: 'suplementos.html?tipo=combos', label: 'Combos' },
        { href: 'suplementos.html?tipo=ganadores', label: 'Ganadores de peso' },
        { href: 'suplementos.html?tipo=cafeina-energia', label: 'Cafeína y energía' },
        { href: 'suplementos.html?tipo=carbo-isotonicos', label: 'Carbohidratos · Isotónicos' },
      ],
    },
    {
      ...
      subs: [
        { href: 'supermercado.html?tipo=aceites-vinagres', label: 'Aceites y vinagres' },
        { href: 'supermercado.html?tipo=panales-absorbentes', label: 'Pañales y absorbentes' },
        { href: 'supermercado.html?tipo=salsas-jarabes', label: 'Salsas y jarabes' },
        { href: 'supermercado.html?tipo=pasta-mani', label: 'Pasta de maní' },
        { href: 'supermercado.html?tipo=almacen-fit', label: 'Almacén fit' },
        { href: 'supermercado.html?tipo=miel-endulzantes', label: 'Miel y endulzantes' },
        { href: 'supermercado.html?tipo=yerba-mate', label: 'Yerba mate' },
      ],
    },
    {
      ...
      subs: [
        { href: 'electro.html?tipo=cocina-electrica', label: 'Cocina eléctrica' },
        { href: 'electro.html?tipo=bano-espejos', label: 'Baño y espejos' },
        { href: 'electro.html?tipo=salud-medicion', label: 'Salud y medición' },
        { href: 'electro.html?tipo=cuidado-personal', label: 'Cuidado personal' },
        { href: 'electro.html?tipo=grandes-electro', label: 'Grandes electro' },
        { href: 'electro.html?tipo=limpieza', label: 'Limpieza' },
        { href: 'electro.html?tipo=herramientas', label: 'Herramientas' },
        { href: 'electro.html?tipo=climatizacion', label: 'Climatización' },
      ],
    },
    {
    ...
    },
    {
      ...
      subs: [
        { href: 'bodega.html?tipo=vinos-tintos', label: 'Vinos tintos' },
        { href: 'bodega.html?tipo=vinos-blancos', label: 'Vinos blancos' },
        { href: 'bodega.html?tipo=destilados', label: 'Destilados' },
        { href: 'bodega.html?tipo=espumantes', label: 'Espumantes' },
      ],
    },
    {
